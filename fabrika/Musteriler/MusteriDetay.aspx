...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <div class="col-lg-12">
            <div class="panel" style="background-color: #f8f4e8; border-radius: 5px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
                <div class="panel-body">
                    <div class="row">
                        <!-- Müşteri Profil Resmi ve Temel Bilgiler -->
                        <div class="col-md-6">
                            <div class="row">
                                <div class="col-md-3">
                                    <asp:Image ID="MusteriResim" runat="server" Width="100px" />
                                    <%--<img src="../../App_Themes/serdarnas_admin_flat/img/avatar1_small.jpg" alt="Müşteri Profil" class="img-circle" style="width: 80px; height: 80px;" />--%>
                                </div>
                                <div class="col-md-9">
                                    <h4>
                                        <asp:Label ID="lblMusteriAdi" runat="server" Text="3em gıda sanayi ticaret ltd.şti"></asp:Label></h4>
                                    <p>
                                        <i class="icon-home"></i>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="btn-group">
                <asp:HyperLink ID="hplinkSatisYap" runat="server" CssClass="btn btn-shadow btn-primary" Style="margin-right: 5px;">
                    <i class="icon-tag"></i> Satış Yap
                </asp:HyperLink>
                <asp:LinkButton ID="btnTahsilatGir" runat="server" CssClass="btn btn-shadow btn-success" Style="margin-right: 5px;">
                    <i class="icon-money"></i> Tahsilat Gir
                </asp:LinkButton>
                <asp:LinkButton ID="btnFaturaOlustur" runat="server" CssClass="btn btn-shadow btn-info" Style="margin-right: 5px;">
                    <i class="icon-file-text"></i> Fatura Oluştur
                </asp:LinkButton>
                <asp:LinkButton ID="btnHesapEkstresi" runat="server" CssClass="btn btn-shadow btn-warning" Style="margin-right: 5px;">
                    <i class="icon-list"></i> Hesap Ekstresi
                </asp:LinkButton> 
                <asp:HyperLink ID="hplinkMusteriGuncelle" runat="server" CssClass="btn btn-shadow btn-info" Style="margin-right: 5px;">
                    <i class="icon-edit"></i> Müşteri Güncelle
                </asp:HyperLink>
    ...
    <div class="row">
        <div class="col-lg-12">
            <section class="panel">
                <header class="panel-heading">
                    <h4>ALIŞLAR / İADELER <i class="icon-angle-down pull-right"></i></h4>
                </header>
                <div class="panel-body">
                    <div class="adv-table">
                        <table class="table table-striped table-hover table-bordered">
