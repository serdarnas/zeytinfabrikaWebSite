...
public partial class fabrika_Musteriler_TahsilatSenetAl : System.Web.UI.Page
{
    ...
    protected void btnTemizle_Click(object sender, EventArgs e)
    {
        ...
        ddlSenetDurumu.SelectedValue = "Portföyde";
        lblTutarGoster.Text = "0,00";
        lblVadeGoster.Text = "-";
        lblBorcluGoster.Text = "-";
