<%@ Page Title="Çek Tahsilat" Language="C#" MasterPageFile="~/fabrika/FabrikaMasterPage.master" AutoEventWireup="true" CodeFile="TahsilatCek.aspx.cs" Inherits="fabrika_Musteriler_TahsilatCek" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="container-fluid py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2 class="mb-0"><i class="bi bi-credit-card-2-front"></i> Çek Tahsilat</h2>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="payment-form">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            <label class="form-label"><i class="bi bi-cash"></i> Çek Tutarı</label>
                        ...
                        <div class="col-md-6">
                            <label class="form-label"><i class="bi bi-hash"></i> Çek Numarası</label>
                            <asp:TextBox ID="txtCekNo" runat="server" CssClass="form-control" placeholder="Çek numarası"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="rfvCekNo" runat="server" ControlToValidate="txtCekNo" 
                                ErrorMessage="Çek numarası girilmelidir" CssClass="text-warning small" Display="Dynamic"></asp:RequiredFieldValidator>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label"><i class="bi bi-building"></i> Banka Adı</label>
                            <asp:TextBox ID="txtBankaAdi" runat="server" CssClass="form-control" placeholder="Banka adı"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="rfvBankaAdi" runat="server" ControlToValidate="txtBankaAdi" 
                                ErrorMessage="Banka adı girilmelidir" CssClass="text-warning small" Display="Dynamic"></asp:RequiredFieldValidator>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label"><i class="bi bi-geo-alt"></i> Şube</label>
                            <asp:TextBox ID="txtSube" runat="server" CssClass="form-control" placeholder="Şube adı"></asp:TextBox>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label"><i class="bi bi-calendar"></i> Çek Tarihi</label>
                            <asp:TextBox ID="txtCekTarihi" runat="server" CssClass="form-control" TextMode="Date"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="rfvCekTarihi" runat="server" ControlToValidate="txtCekTarihi" 
                                ErrorMessage="Çek tarihi girilmelidir" CssClass="text-warning small" Display="Dynamic"></asp:RequiredFieldValidator>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <label class="form-label"><i class="bi bi-list-check"></i> Çek Durumu</label>
                            <asp:DropDownList ID="ddlCekDurumu" runat="server" CssClass="form-select">
                                <asp:ListItem Value="Portföyde" Text="Portföyde" Selected="True"></asp:ListItem>
                                <asp:ListItem Value="Bankada" Text="Bankada"></asp:ListItem>
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                        ...
                        <asp:Button ID="btnKaydet" runat="server" Text="Çeki Kaydet" CssClass="btn btn-payment" 
            ...
            <div class="col-12">
                <div class="card shadow-sm">
                    <div class="card-header bg-light">
                        <h5 class="mb-0"><i class="bi bi-clock-history"></i> Son Çek İşlemleri</h5>
                    </div>
                    <div class="card-body">
                        <asp:Repeater ID="rptSonCekler" runat="server">
                            <ItemTemplate>
                                <div class="d-flex justify-content-between align-items-center py-2 border-bottom">
                                    <div>
                                        <strong><%# String.Format("{0:N2}", Eval("Tutar")) %> ₺</strong>
                                        <small class="text-muted d-block">Çek No: <%# Eval("CekNo") %></small>
                                        <small class="text-muted d-block"><%# Eval("BankaAdi") %></small>
                                    </div>
                                    <div class="text-end">
                                        <span class="badge bg-info"><%# Eval("CekDurumu") %></span>
                                        <small class="text-muted d-block">Vade: <%# String.Format("{0:dd.MM.yyyy}", Eval("VadeTarihi")) %></small>
                                    </div>
                                </div>
                            </ItemTemplate>
                        </asp:Repeater>
                        <asp:Panel ID="pnlSonCekYok" runat="server" Visible="false" CssClass="text-center py-4">
                            <i class="bi bi-info-circle text-muted" style="font-size: 2rem;"></i>
                            <p class="text-muted mt-2">Henüz çek işlemi bulunmuyor.</p>
                        </asp:Panel>
                    </div>
                </div>
            </div>
    ...
    <script type="text/javascript">
        ...
        document.getElementById('<%= ddlCekDurumu.ClientID %>').addEventListener('change', function() {
        ...
        window.addEventListener('load', function() {
            ...
            document.getElementById('<%= txtCekTarihi.ClientID %>').value = today;
            
            // Vade tarihini 30 gün sonra set et
