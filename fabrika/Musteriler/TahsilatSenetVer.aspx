<%@ Page Title="Senet Ver" Language="C#" MasterPageFile="~/fabrika/FabrikaMasterPage.master" AutoEventWireup="true" CodeFile="TahsilatSenetVer.aspx.cs" Inherits="fabrika_Musteriler_TahsilatSenetVer" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="container-fluid py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2 class="mb-0"><i class="bi bi-file-earmark-arrow-up"></i> Senet Ver</h2>
            ...
            <div class="col-lg-10">
                <div class="payment-form">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <label class="form-label"><i class="bi bi-person"></i> Alacaklı Adı</label>
                            <asp:TextBox ID="txtAlacakliAdi" runat="server" CssClass="form-control" placeholder="Alacaklı adı"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="rfvAlacakliAdi" runat="server" ControlToValidate="txtAlacakliAdi" 
                                ErrorMessage="Alacaklı adı girilmelidir" CssClass="text-warning small" Display="Dynamic"></asp:RequiredFieldValidator>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <asp:DropDownList ID="ddlSenetDurumu" runat="server" CssClass="form-select">
                                <asp:ListItem Value="Verildi" Text="Verildi" Selected="True"></asp:ListItem>
                                <asp:ListItem Value="Ödendi" Text="Ödendi"></asp:ListItem>
                                <asp:ListItem Value="İade Alındı" Text="İade Alındı"></asp:ListItem>
                    ...
                    <div class="promissory-info">
                        <div class="row text-center">
                            ...
                            <div class="col-md-3">
                                <h5><asp:Label ID="lblAlacakliGoster" runat="server" Text="-"></asp:Label></h5>
                                <small>Alacaklı</small>
                            </div>
                            <div class="col-md-3">
                                <h5><asp:Label ID="lblDurumGoster" runat="server" Text="Verildi"></asp:Label></h5>
                                <small>Durum</small>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-12">
                <div class="card shadow-sm">
                    <div class="card-header bg-light">
                        <h5 class="mb-0"><i class="bi bi-clock-history"></i> Son Verilen Senetler</h5>
                    </div>
                    <div class="card-body">
                            ...
                            <ItemTemplate>
                                <div class="d-flex justify-content-between align-items-center py-2 border-bottom">
                                    <div>
                                        ...
                                        <small class="text-muted d-block">Alacaklı: <%# Eval("AlacakliAdi") %></small>
                                    </div>
                                    <div class="text-end">
                                        <span class="badge bg-warning"><%# Eval("SenetDurumu") %></span>
                        ...
                        <asp:Panel ID="pnlSonSenetYok" runat="server" Visible="false" CssClass="text-center py-4">
                            ...
                            <p class="text-muted mt-2">Henüz verilen senet bulunmuyor.</p>
                        </asp:Panel>
                    </div>
                </div>
            </div>
    ...
    <script type="text/javascript">
        ...
        // Alacaklı adı değiştiğinde gösterimi güncelle
        document.getElementById('<%= txtAlacakliAdi.ClientID %>').addEventListener('input', function() {
            document.getElementById('<%= lblAlacakliGoster.ClientID %>').innerText = this.value || '-';
        });
